...
namespace Generics.CollectionRepository
{
    ...
    public class GenericDictionary<TKey, TValue>
    {
        ...
        {
            Console.WriteLine($"\n--------TABLE--------".Pastel(ConsoleColor.Magenta));
        ...
        public void RemoveItemFromDictionary(TKey deleteKey)
        {
            ...
            {
                Console.WriteLine($"\n'Key : {deleteKey}' is successfully deleted from the dictionary !!".Pastel(ConsoleColor.Cyan));
            }
            else
            {
                Console.WriteLine($"\n'Key : {deleteKey}' is not present in the dictionary !!".Pastel(ConsoleColor.Red));
            }
        }
